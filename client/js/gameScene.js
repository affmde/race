...
class GameScene extends Phaser.Scene{
    ...
    create(){
        ...
        if(device!=='desktop'){
            ...
            this.accelerationBtn= this.add.image(w-150, h-50, 'gameScenePs4CrossBtn').setOrigin(0.5).setInteractive().setScrollFactor(0).setAlpha(0.9);
            this.breakBtn= this.add.image(w-100, h-100, 'gameScenePs4CircleBtn').setOrigin(0.5).setInteractive().setScrollFactor(0).setAlpha(0.9);
        }
