...
class GameScene extends Phaser.Scene{
    ...
    create(){
        ...
        if(device!=='desktop'){
            ...
            this.accelerationBtn= this.add.image(w-190, h-75, 'gameScenePs4CrossBtn').setOrigin(0.5).setInteractive().setScrollFactor(0).setAlpha(0.7);
            this.breakBtn= this.add.image(w-80, h-210, 'gameScenePs4CircleBtn').setOrigin(0.5).setInteractive().setScrollFactor(0).setAlpha(0.7);
        }
